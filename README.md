...
## 🛠️ Aegon Blender Addon Pack (v7.0.0)

| Tool | Description | Feature |
| :--- | :--- | :--- |
| **🟢 Aegon Boolean PRO** | Advanced parametric boolean & slice system. | Automated cleanup |
| **📦 Aegon UVW Box Map** | One-click box mapping method. | No stretching textures |
| **🎯 Perfect Align** | Aligns faces to active UV coordinates. | Perfect positioning |
| **🧠 Smart UV Stack** | Experimental AI for identical parts. | Save texture space |
